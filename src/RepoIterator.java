...
public class RepoIterator {
	...
	private ArrayList<String> exoName, exoNameExact; // list of valid exoname for event , list of valid exoname that must have been tried by a student to be valid 
	private ArrayList<String> validBranch;
